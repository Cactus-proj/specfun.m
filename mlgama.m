...
%                Γ(x)for x > 0 using subroutine LGAMA
%       Examples:
%                  x           Γ(x)
%                -------------------------
%                 0.5     .1772453851D+01
...
%       ==================================================
%       Purpose: Compute gamma function Γ(x)or ln[Γ(x)]
%       Input:   x  --- Argument of Γ(x,x > 0)
%                KF --- Function code
%                       KF=1 for Γ(x); KF=0 for ln[Γ(x)]
%       Output:  GL --- Γ(x)or ln[Γ(x)]
%       ==================================================
 a=zeros(1,10);
