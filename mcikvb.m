...
n=fix(v);
v0=v-n;
fprintf(1,[repmat(' ',1,8),'v= n+v0',',   ','v0 =','%6.2g',',   ','z =','%5.1g','+ i','%5.1g' ' \n'],v0,x,y);
if(n <= 8);
    ns=1;
else;
...
[v,z,vm,cbi,cdi,cbk,cdk]=cikvb(v,z,vm,cbi,cdi,cbk,cdk);
nm=fix(vm);
fprintf(1,'%0.15g \n');
...
%format(8x,'v= n+v0',',   ',',f6.2,',   ',',f5.1, '+ i',f5.1);
end
function [v,z,vm,cbi,cdi,cbk,cdk]=cikvb(v,z,vm,cbi,cdi,cbk,cdk,varargin);
%       ===========================================================
...
if(a0 < 18.0);
    ...
    for  k=1:50;
        ...
        ci0=ci0+cr;
        if(abs(cr./ci0)< 1.0d-15)break; end;
    end;
    cbi0=ci0.*ca1;
else;
...
if(a0 <= 9.0);
    if(v0 == 0.0);
        ...
        for  k=1:50;
            ...
            cp=ca2.*cr1-ca1.*cr2;
            csu=csu+cp;
            if(k >= 10&abs(cp./csu)< 1.0d-15)break; end;
        end;
